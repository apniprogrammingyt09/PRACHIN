...
import { ChevronLeft, Upload, Plus, X, Star } from "lucide-react"
...
export default function NewProductPage() {
  ...
  const allergenOptions = ["Gluten", "Dairy", "Eggs", "Nuts", "Soy"]
    ...
    <div>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-[#2D5016]">Add New Product</h1>
            <p className="text-[#4A7C59]">Create a new product for your Ayurvedic wellness center</p>
          </div>
        </div>
