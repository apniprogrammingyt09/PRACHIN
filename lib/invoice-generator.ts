...
export function generateInvoicePDF(order: Order): jsPDF {
  ...
  doc.text("Phone: +91-87087-18784, +91-72069-07250 | Email: prachinayurvedindia@gmail.com | Web: www.prachinayurved.in", 20, 54)
  ...
  doc.text("Email: prachinayurvedindia@gmail.com | Phone: +91-87087-18784, +91-72069-07250 | Web: www.prachinayurved.in", pageWidth / 2, footerY + 18, { align: 'center' })
