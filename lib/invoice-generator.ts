...
export function generateInvoicePDF(order: Order): jsPDF {
  ...
  doc.text("Phone: +91-9876543210 | Email: info@prachinayurved.com | Web: www.prachinayurved.com", 20, 54)
  ...
  doc.text("Email: info@prachinayurved.com | Phone: +91-9876543210 | Web: www.prachinayurved.com", pageWidth / 2, footerY + 18, { align: 'center' })
